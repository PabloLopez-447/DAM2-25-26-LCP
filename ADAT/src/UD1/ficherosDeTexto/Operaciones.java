...
public class Operaciones {
    ...
    public static void crearDirectorios(String archivoEntrada, String log) {
        UD1.ay.ACT2.LecturaTexto lector = new UD1.ay.ACT2.LecturaTexto(archivoEntrada);
        lector.abrirArchivo();

        UD1.ay.ACT2.EscribirTexto escritor = new UD1.ay.ACT2.EscribirTexto(log);
    ...
    public static void contarPalabras(String archivoEntrada, String palabra, String archivoSalida) {
        ...
        UD1.ay.ACT2.EscribirTexto escritor = new UD1.ay.ACT2.EscribirTexto(archivoSalida);
        escritor.abrirArchivo();
