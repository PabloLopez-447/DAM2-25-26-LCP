package UD2.empresa25.eva.actividad4.model;
...
public class Familiar {
    ...
    // CORRECCION: constructor de dominio, numInterno se calcula en la lógica
    public Familiar(String nssEmpregado,
                    String nssFamiliar,
                    String nome,
                    String apelidos,
                    Date dataNacemento,
    ...
    public Familiar(String nssEmpregado, int numInterno, String nssFamiliar,
                    String nome, String apelidos, Date dataNacemento,
