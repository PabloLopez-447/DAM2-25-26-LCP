...
//        cambiarDeptEmpleado();
    ...
    private static void executarAltaHabilidades() {
        List<Habilidade> lista = new ArrayList<>();
        lista.add(new Habilidade("Java"));
        lista.add(new Habilidade("Hibernate"));
        lista.add(new Habilidade("Contaplus")); // Chamada á lóxica (o main non imprime nada) HabilidadeLogica.altaHabilidades(lista); }
// Chamada á lóxica
        GestorEmpresaHB.altaHabilidades(lista);
    }
