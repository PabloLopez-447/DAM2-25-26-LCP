...
public class Empregado implements java.io.Serializable {
  ...
  //El tipo de dato Date o Calendar hay que a�adir @Temporal(javax.persistence.TemporalType.DATE)
    ...
    //si queremos que empiece en 1 esta anotaci�n  no se podria y lo generar�amos por c�digo
