package UD2.Sockets.Ejercicios.estadoUsuarios;
        ...
        try {
            ...
            if (loginOk) {
                ...
                switch(Config.AutorizarConexion.values()[codRespuestaAutorizacion]) {
                    case CredencialesIncorrectas: error="Usuario y/o contraseña incorrecta";break;
                    case UsuarioYaConectado: error="Usuario conectado en otro terminal"; break;
                }
