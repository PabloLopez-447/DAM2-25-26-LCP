...
public class UsoJlist extends JFrame {
	...
	private DefaultListModel<Alfombra> modeloAlfombras;
	...
	public UsoJlist() {
		...
		gbl_panel_1.columnWidths = new int[]{601, 170, 0};
		...
		JList<Alfombra> listAlfombras = new JList<Alfombra>();
		listAlfombras.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(e.getClickCount()==2)
				 {
				JOptionPane.showMessageDialog(listAlfombras, "Non hai alfombras dispoñibles");
				return;
				 }

				if(listAlfombras.getSelectedIndex()==-1)
				 {
				JOptionPane.showMessageDialog(listAlfombras, "Debe seleccionar ao menos unha alfombra");
				return;
				 }

				int posicionsSeleccionados[]=listAlfombras.getSelectedIndices();
				String mensaxe="";
				...
				JOptionPane.showMessageDialog(listAlfombras, mensaxe); 
			}
		});
		GridBagConstraints gbc_listAlfombras = new GridBagConstraints();
		gbc_listAlfombras.gridheight = 4;
		gbc_listAlfombras.insets = new Insets(0, 0, 0, 5);
		gbc_listAlfombras.fill = GridBagConstraints.BOTH;
		gbc_listAlfombras.gridx = 0;
		gbc_listAlfombras.gridy = 0;
		panel_1.add(listAlfombras, gbc_listAlfombras);
		listAlfombras.setModel(modeloAlfombras);
		...
		btnInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(btnInfo, mensaxe); 
			}
		});
